...
const { FiExternalLink, FiGithub, FiCode, FiDatabase, FiSmartphone } = FiIcons;
...
const Projects = () => {
  const projects = [
    ...
    },
    {
      ...
      tech: ["React", "Node.js", "Chart.js", "Redis"],
      liveUrl: "https://example.com",
      githubUrl: "https://github.com",
      icon: FiSmartphone
    }
        ...
        >
          {projects.map((project, index) => (
            <motion.div
              ...
              className="bg-gray-900/50 rounded-xl overflow-hidden border border-gray-700 hover:border-blue-500/50 transition-all duration-300 group"
            >
              <div className="relative overflow-hidden">
                ...
                <div className="absolute top-4 right-4">
                  <div className="w-10 h-10 bg-blue-500/20 backdrop-blur-sm rounded-full flex items-center justify-center">
                    <SafeIcon icon={project.icon} className="text-blue-400" />
                  </div>
                </div>
              </div>
